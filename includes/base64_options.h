...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/19 16:50:52 by ykolomie          #+#    #+#             */
/*   Updated: 2019/04/19 16:50:53 by ykolomie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef	int			(*t_b64_optparser)(int pos, int argc, char **argv,
...
int					b64_break_option_handler(int pos, int argc, char **argv,
						t_base64_options *options);
int					b64_help_option_handler(int pos, int argc, char **argv,
						t_base64_options *options);

void				base64_parse_options(t_base64_options *options, int argc,
						char **argv);
